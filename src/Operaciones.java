...
/* ********************************************METODOS PARA VERIFICACION DE SINTAXIS*****************************************/
    ...
    public int recorrido(ArrayList<String> fileContent, AutomataDFA ident, AutomataDFA set, AutomataDFA string, CocolStructure structure){
    ...
    public int TokenDecl(String lineaDeToken, AutomataDFA ident){
        int result=0;
        if(lineaDeToken.contains("=")){
            String[] tokenParts = lineaDeToken.split("");
            ...
            if(!simulacionAFDdirecto(ident, lineaDeToken) == true){
                result = 16;
                return result;
            }
        }
    ...
    public int TokenExpr(String linea){
        int result=0;
        if(linea.contains("")){
    ...
    public void Errors(int numberOfError){
        switch (numberOfError){
            ...
            case 14:
                ...
                break;
            case 15:
                System.err.println("Error de Sintaxis #15: Palabra inicial para Tokens esta mal escrita.");
                break;
            case 16:
                System.err.println("Error de Sintaxis #16: Identificador para token incorrecto dentro de Tokens.");
                break;
            case 17:
                System.err.println("Error de Sintaxis #1: Token no termina con '.' ,  dentro de Tokens.");
                break;
            default:
